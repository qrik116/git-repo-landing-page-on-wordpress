...
<!--						<label class="description" for="sample_theme_options[sometext]"><?php _e( 'Sample text input', 'sampletheme' ); ?></label>-->
				...
				<tr valign="top"><th scope="row"><?php _e( 'Телефон', 'sampletheme' ); ?></th>
					<td>
						<input id="sample_theme_options[telephone]" class="regular-text" type="text" name="sample_theme_options[telephone]" value="<?php esc_attr_e( $options['telephone'] ); ?>" />
<!--						<label class="description" for="sample_theme_options[sometext]"><?php _e( 'Sample text input', 'sampletheme' ); ?></label>-->
					</td>
				</tr>
...
<!--						<label class="description" for="sample_theme_options[sometext]"><?php _e( 'Sample text input', 'sampletheme' ); ?></label>-->
                ...
                <tr valign="top"><th scope="row"><?php _e( 'Skype', 'sampletheme' ); ?></th>
					<td>
						<input id="sample_theme_options[skype]" class="regular-text" type="text" name="sample_theme_options[skype]" value="<?php esc_attr_e( $options['skype'] ); ?>" />
<!--						<label class="description" for="sample_theme_options[sometext]"><?php _e( 'Sample text input', 'sampletheme' ); ?></label>-->
					</td>
				</tr>
...
//	$input['option1'] = ( $input['option1'] == 1 ? 1 : 0 );
    ...
    $input['website'] = wp_filter_nohtml_kses( $input['website'] );
